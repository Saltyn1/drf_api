# Generated by Django 3.1 on 2021-06-21 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[("('new', 'Новый')", 'New'), ('in_progress', 'В обработке'), ('done', 'Выполнен'), ('canceled', 'Отменён')], max_length=20)),
